...
import Referral2 from './assets/images/Referral2.png'; 
...
const ReferralScreen2: React.FC = () => {
  const [isCopied, setIsCopied] = useState(false);

  const handleCopy = () => {
    navigator.clipboard.writeText('AnyFeast.co');
    setIsCopied(true);
  ...
  return (
    <div>
      ...
      {/* <div className="flex justify-e mb-6 mr-0">
          <img
            src={Referral2}
            alt="Referral Offer"
            className="w-24 h-24" // Adjust width and height as needed
          />
        </div> */}
...
export default ReferralScreen2;
